...
const { handleAddNewCandidate, handleAddVotingInfo, handleCandidateLogin, handleCandidateCurrentElection, handleShowRegisterElectionCandidate, handleLiveResult, handleWinElection, handleRemoveNameFromElection } = require("../controllers/candidate");
